...
const offAnimationBtn = document.getElementById('offAnimationBtn');
offAnimationBtn.addEventListener('click', () => {
    main(fourPoints, false); 
});
...
async function main(fourPoints, animation) {
    ...
    function render(time) {
        ...
        const eye = [30 * calcBezierX, 10, 40 * calcBezierZ];
        const target = [tangent[0], 10, tangent[1]];
        const up = [0, 1, 0];
