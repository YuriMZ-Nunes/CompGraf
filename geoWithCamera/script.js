...
parameters.appletOnLoad = function(api){
    ...
    fourPoints.push(ggbApplet.getXcoord("D"));
    fourPoints.push(ggbApplet.getYcoord("D"));

    fourPoints.push(ggbApplet.getXcoord("E"));
    fourPoints.push(ggbApplet.getYcoord("E"));

    fourPoints.push(ggbApplet.getXcoord("F"));
    fourPoints.push(ggbApplet.getYcoord("F"));

    fourPoints.push(ggbApplet.getXcoord("G"));
    fourPoints.push(ggbApplet.getYcoord("G"));
