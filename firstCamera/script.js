...
function main() {
  ...
  webglLessonsUI.setupSlider("#cameraPosition", {value: cameraPosition, slide: updateCameraPosition, min: 0, max: 10, step: 0.01});
  ...
  function updateCameraPosition(event, ui) {
    cameraPosition = ui.value;
    drawScene();
  }
  ...
  function drawScene() {
    ...
    cameraMatrix = m4.translate(cameraMatrix, 0, 0, radius * cameraPosition);
