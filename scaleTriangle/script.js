...
void main() {
    ...
    vec2 rotatedPosition = vec2(
        ((scaledPosition.x - center.x) * u_rotation.y) - ((scaledPosition.y - center.y) * u_rotation.x) + center.x,
        ((scaledPosition.x - center.x) * u_rotation.x) + ((scaledPosition.y - center.y) * u_rotation.y) + center.y);
